...
export const AnimatedBackground: React.FC<AnimatedBackgroundProps> = ({
  ...
  return (
    <AnimatedBackgroundContainer
      ...
      height={height}
    >
      <BackgroundStripe height={height / 5} scaleX={show ? "scaleX(1)" : "scaleX(0)"} />
      <BackgroundStripe2 height={height / 5} scaleX={show ? "scaleX(1)" : "scaleX(0)"} />
      <BackgroundStripe3 height={height / 5} scaleX={show ? "scaleX(1)" : "scaleX(0)"} />
      <BackgroundStripe4 height={height / 5} scaleX={show ? "scaleX(1)" : "scaleX(0)"} />
      <BackgroundStripe5 height={height / 5} scaleX={show ? "scaleX(1)" : "scaleX(0)"} />
      <ChildrenContainer
        opacity={show ? 1 : 0}
